...
const gpaLabel = ["0-2.6", "2.6-2.8", "2.8-3.0", "3.0-3.2", 
                  "3.2-3.4", "3.4-3.6", "3.6-3.8", "3.8-4.0"];

const percentageLabel = ["0-76", "76-78", "78-80", "80-82", 
                        "80-82", "82-84", "84-86", "86-88", "88-90", "90-100"];
    ...
    series: [
      {
        ...
        data: school[label.dataLabel].map((item: object) => -item["rejected_num"]),
        itemStyle: {
      ...
      },
      {
        ...
        data: school[label.dataLabel].map((item: object) => item["accepted_num"]),
        itemStyle: {
...
Page({
  ...
  onLoad: function (options: object) {
    ...
    school["avg_grade"]["gpa_score"] = gpa.toFixed(2);
    school["avg_grade"]["percentage_score"] = percentage.toFixed(2);
    ...
    labels['percentage'].yourIndex = this.calcIndex('percentage', percentage_score);
    this.setData({
      school: school
    });
  }
